...
class RaportBestSellingHO extends Raport{
    ...
    public function generate($month = null, $year = null){
        ...
        if($this->dateFrom != null && $this->dateTo != null){
            ...
            $query = "SELECT rp_obroty.symbol, CONCAT(producent, ' ', bazaopon.nazwa) AS NAZWA, MAGAZYN, CENA_KATALOGOWA, SUM(rp_obroty.ILOSC) AS SUMA_ILOSC, ROUND(SUM(rp_obroty.cena_brutto), 2) AS SUMA_WARTOSC, ROUND((SUM(cena_brutto) / SUM(rp_obroty.ILOSC)), 2) AS SREDNIA_CENA_SPRZEDAZY
            FROM bazaopon
